# nomad-measurements-raman

NOMAD plugin for Raman spectroscopy and AFM maps
...
```sh
git clone https://github.com/abbasgholami71/nomad-measurements-raman.git
cd nomad-measurements-raman
